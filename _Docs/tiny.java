...
public class tiny {
     ...
     /**************************************************/
     /***** a partir da posi‡Æo 400 do vetor[j] ********/
...
/*******************************************************************/
     ...
     static int[] cmd(String[] result, int[] memoria){
      ...
      if (pal.equalsIgnoreCase("IDE")) {
         System.out.println("AS cmd atribui‡Æo **");
         y=4;
         tempint2=0;
...
/*****************************************************************/
    public static void main(String[] args) throws IOException {
		...
		// Na matriz result vou guardar os tokens da análise léxica
       ...
       while (i<1000) {
		...
		// ********* como o ponteiro do léxico e da memória
		// ********* Mas quando vou gerar o código, começo da posição i=10, lógico
        ...
        memoria[14]=0;
        memoria[15]=0;
        memoria[2]=15;    /****** ponteiro da memória do CMS *****/
        memoria[1]=3;     /****** ponteiro do vetor léxico ****/
